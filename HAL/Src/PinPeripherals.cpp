 ...
 * @brief This file is copied from MBEDs STM32F446 implementation of pin maps.
 * @version 0.1
 * @date 2024-04-04
 * 
...
const PinMap PinMap_SPI_MOSI[] = {
    {PA_7,       SPI_1, GPIO_AF5_SPI1},
    {PB_0,       SPI_3, GPIO_AF7_SPI3},
    {PB_2,       SPI_3, GPIO_AF7_SPI3},
    {PB_5,       SPI_1, GPIO_AF5_SPI1},
    {PB_15,      SPI_2, GPIO_AF5_SPI2},
    {PC_1,       SPI_2, GPIO_AF7_SPI2},
    {PC_3,       SPI_2, GPIO_AF5_SPI2},
    {PC_12,      SPI_3, GPIO_AF6_SPI3},
    {NC, NC, 0}
};

const PinMap PinMap_SPI_MISO[] = {
    {PA_6,       SPI_1, GPIO_AF5_SPI1},
    {PB_4,       SPI_1, GPIO_AF5_SPI1},
    {PB_14,      SPI_2, GPIO_AF5_SPI2},
    {PC_2,       SPI_2, GPIO_AF5_SPI2},
    {PC_11,      SPI_3, GPIO_AF6_SPI3},
    {NC, NC, 0}
};

const PinMap PinMap_SPI_SCLK[] = {
    {PA_5,       SPI_1, GPIO_AF5_SPI1},
    {PA_9,       SPI_2, GPIO_AF5_SPI2},
    {PB_3,       SPI_1, GPIO_AF5_SPI1},
    {PB_10,      SPI_2, GPIO_AF5_SPI2},
    {PB_13,      SPI_2, GPIO_AF5_SPI2},
    {PC_7,       SPI_2, GPIO_AF5_SPI2},
    {PC_10,      SPI_3, GPIO_AF6_SPI3},
    {NC, NC, 0}
};

const PinMap PinMap_SPI_SSEL[] = {
    {PA_4,       SPI_1, GPIO_AF5_SPI1},
    {PA_15,      SPI_1, GPIO_AF5_SPI1},
    {PB_4,       SPI_2, GPIO_AF7_SPI2},
    {PB_9,       SPI_2, GPIO_AF5_SPI2},
    {PB_12,      SPI_2, GPIO_AF5_SPI2},
    {NC, NC, 0}
};
